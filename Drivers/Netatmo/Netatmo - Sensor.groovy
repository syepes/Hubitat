...
def motion(String type) {
  ...
  if(logDescText) { log.info "Has detected motion (${type})" }
...
def updateCheck() {
  def params = [uri: "https://raw.githubusercontent.com/syepes/Hubitat/master/Drivers/Netatmo/Netatmo%20-%20Sensor.groovy"]
